...
* rewrite consumer for runtimedatamanager
...
* no data updates causing error logs
...
* cwls inactive highlights
* use reliablefilestorage and reduce locking on fw tick
